...
module Rm
  module Activity
    ...
    class Fetcher
      ...
      @@constantized_providers = Hash.new { |h, k| h[k] = Rm::Activity.providers[k].collect { |t| t.constantize } }
      ...
      def event_types
        ...
        @event_types = Rm::Activity.available_event_types
      ...
      def default_scope!
        @scope = Rm::Activity.default_event_types
      end
